...
The behaviors and FSM is described in more detail in [next section]({{ site.baseurl }}{% post_url 2017-10-13-01_introduction_03_behaviors %}).
...
described in [next section]({{ site.baseurl }}{% post_url 2017-10-13-01_introduction_03_behaviors %}).
